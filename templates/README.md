...
| [`code-review.json`](./code-review.json) | Read PR → (security?) → style → write review | A condition that branches and rejoins |
...
1. Copy the file (or its contents) to `.conductor/conductor.json`.
