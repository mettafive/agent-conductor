...
export const EXAMPLES: Example[] = [
  ...
  },
  {
    id: "treatment-page",
    name: "treatment-page",
    tagline: "Branches on whether insurance matters, then rejoins through the requires graph.",
    pattern: "Branching",
    accent: "cyan",
  ...
  },
  {
    id: "code-review",
    name: "code-review",
    tagline: "A security branch plus coverage and style review instructions.",
    pattern: "Branching",
    accent: "mint",
