      ...
      <nav className="mx-auto flex h-14 max-w-6xl items-center justify-between px-5">
        ...
        <div className="hidden items-center gap-1 md:flex">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="ml-2 flex items-center gap-2 rounded-lg border border-line-2 bg-panel px-3 py-2 text-sm text-chalk transition-colors hover:border-line-2 hover:bg-panel-2"
          >
